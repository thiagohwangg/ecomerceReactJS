...
export default function Contents() {
    ...
    const { containerContents, boxFooter, boxCoupon, boxBtnDelete,boxEmptyCart,titleEmpty,boxBtnEmpty } = styles;
        ...
        <>
            {listProductCart.length > 0 && userId ? (
                ...
                <div className={boxEmptyCart}>
                    ...
                    <div>We invite you to get acquainted with an assortment of our shop. Surely you can find something for yourself!</div>
