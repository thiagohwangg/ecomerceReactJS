...
export default function ProductItem({
    ...
    const handleAddToCart = () => {
        handleAddProductToCartCommon(userId, setIsOpen, setType, toast, sizeChoose, details._id, 1, setIsLoading, handleGetListProductCart);
    }
    ...
    return (
        <div className={isShowGrid ? '' : containerItem} style={{cursor: 'pointer'}}>
            ...
            <div className={isShowGrid ? '' : content} style={{ marginTop: slideItem && '10px'}}>
            {!isHomePage && (
